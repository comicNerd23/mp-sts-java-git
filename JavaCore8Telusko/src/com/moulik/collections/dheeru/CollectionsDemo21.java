 ...
 * 
 * 1. list.toArray(EMPTY_STRING) 	private static final String[] EMPTY_STRING = new String[0];
...
public class CollectionsDemo21 {
	public static void main(String[] args) {
		...
		// list.addAll(Arrays.asList(array)) This will also do the same task as Collections.addAll() but it is likely
