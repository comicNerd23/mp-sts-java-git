...
* Demonstrates,
  ...
  (iii) On instantiating the class, it is loaded from memory (loading was done previous step) and 
	...
	Here is a simple and nice tutorial on creating a dynamic proxy.
	http://www.javaroots.com/2013/03/understanding-dynamic-proxy-springaop.html
*/

interface Superinterface {
	int STATIC_FINAL3 = new ClassInitializationDemo5().getInt();
	int STATIC_FINAL5 = new ClassInitializationDemo5().getInt5();
...
public class ClassInitializationDemo5 {
	{
