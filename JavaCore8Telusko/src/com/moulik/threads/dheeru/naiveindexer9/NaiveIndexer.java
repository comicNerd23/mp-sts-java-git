package com.moulik.threads.dheeru.naiveindexer9;
 ...
 * 
 * The nested classes we are using here are static. Because non-static member classes will store a hidden reference to
 * the enclosing class, NaiveIndexer and we don't need that because we don't need instances of NaiveIndexer class.
 *
 */
