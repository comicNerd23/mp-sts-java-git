...
/**
 * Common Operations:	C-SEE-CRS-C		3-511-311-1
 * 	Comparing						3		str.equals("hello") str.equalsIgnoreCase("hello") str.compareTo("hello")
 * 	Searching						5		str.contains("hel") str.startsWith("ad") str.endsWith("a") str.indexOf("lo")
 * 											str.lastIndexOf("o")
 * 	Examining individual characters	1		str.charAt(int a)
 * 	Extract substrings				1		str.substring(4, 9)
 * 	Case translation				3		str.toUpperCase() str.toLowerCase()	str.trim()
 * 	Replace							1		str.replaceAll("o","r")
 * 	Split							1		str.split("o")
 * 	Conversion						1		String.valueOf(Number) String.join()
 * 
 * Third-party String Utilities
